...
import Vista.CancelacionHipotecaVisualizacion;

public class AbrirCancelacionHipoteca 
{
    CancelacionHipotecaVisualizacion a = new CancelacionHipotecaVisualizacion();
    ...
    public void ObtenerDatosGenerales()
    {
        ...
        sSQL= "SELECT * FROM cancelacionhipoteca WHERE IDNoExpediente = '" + AbrirExpediente.NoExpedinte + "'";        
        try
        {
    ...
    public void ObtenerDatosAcreditado()
    {
        ...
        Connection cn = mysql.getConection();
        int contador=0;
        sSQL= "SELECT * FROM cancelacionhipotecaacreditado WHERE IDNoExpediente = '" + AbrirExpediente.NoExpedinte + "'";
        try
        {
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(sSQL);
        ...
        public void ObtenerDatosAcreditante()
    {
        ...
        Connection cn = mysql.getConection();
        int contador=0;
        sSQL= "SELECT * FROM cancelacionhipotecaacreditante WHERE IDNoExpediente = '" + AbrirExpediente.NoExpedinte + "'";
        try
        {
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(sSQL);
