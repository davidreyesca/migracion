package Controlador;
import static Vista.AperturaCredito.*;
...
public class AperturaCredito {
    ...
    {
        String mensaje ="Los datos de la tabla APERTURA CREDITO se han guardado correctamente";
        ConexionMySql mysql = new ConexionMySql();
        Connection cn = mysql.getConection();
        sSQL= "INSERT INTO aperturacredito(IDNoExpediente, Observaciones) VALUES (?, ?)";        
        try {
            ...
            {
                JOptionPane.showMessageDialog(null, "Hubo un error al insertar los datos en la tabla Apertura credito.");
